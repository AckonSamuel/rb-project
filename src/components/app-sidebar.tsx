      ...
      <SidebarContent className="overflow-x-hidden hide-scrollbar">
        {navData.map((section: any, sectionIdx: number) => (
          <div key={section.title}>
            ...
            <div
              className={`text-white text-md mb-4 ml-6 ${
                section.title === "General" ? "text-[#9e9a9a]" : "mb-8"
              }`}
            >
              {section.title}
            </div>
              ...
              {section.items.map((item: any, itemIdx: number) => (
                ...
                >
                  <div className="text-sm h-8 mb-2 flex gap-2">
                    ...
                    />
                    <div className={`${item.isActive ? "text-[#9BF22B]" : ""} my-auto`}>
                      {item.icon}
                    </div>
                    <a
        ...
        <div className="flex gap-2 mt-8 ml-4 -mr-1">
          <div className="w-8 h-8 bg-[#9BF22B] mt-0 rounded-full" />
          <div>

...
const TotalReturnCard: FC<NetIncomeData> = ({data}) => {
    ...
    <div className="flex flex-col justify-between bg-white border border-gray-800 rounded-lg pt-4 px-4 pb-36 w-30 h-24 shadow-sm">
      ...
      <div className="flex items-center gap-1 text-sm text-green-500">
        ...
        >
          ...
          <path
            d="m852.37 800.31 91.898 -70.582-191.73 -230.98-215.12 170.7-307.74 -358.97 77.062 -66.07 244.04 284.78 216.27 -171.68 257.56 309.61 91.391 -71.074v270.78z"
            fill="red"
          />
        </svg>
        <p className="text-xs text-red-500">{data.percentage_change || 0}</p>{" "}
